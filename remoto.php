           ...
           <div class="hero-container">
              <div class="wow fadeIn">
                 ...
                 <div class="actions">
                    ...
                    <a href="#team" class="btn-services">Suporte remoto</a>
                 </div>
              </div>
           </div>
        </section>
         ...
         <div class="container">
            ...
            <nav id="nav-menu-container">
               <ul class="nav-menu">
                  ...
                  <li><a href="remoto.php">Suporte remoto</a></li>
               </ul>
            </nav>
        </div>
    </header>
                ...
                <div class="col-md-12 col-xs-4">
                    <div>
                        <div class="form-group">  
                            <h3 class="section-title">Acesso remoto</h3>
                            <div class="section-title-divider"></div>
                                <p class="section-description">Usamos os seguintes serviços</p>
                            </div>
                        </div>
                    </div> 
                </div>   
                ...
                <div class="col-md-12 col-xs-4">
                    <table style="width:300px;" class="table table-bordered">
                        <thead class="table-striped">
                            <tr>
                                <th style="background-color: #3671a5; color: white;" class="text-center">Usamos para o acesso remoto os seguintes softwares</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>
                                    <p>
                                        <img src="img/teamviewer.png" alt="teamviewer" style="width:100px;">
                                    </p>
                                    <p>
                                        <img src="img/logmein.png" alt="logmein" style="width:100px;">
                                    </p>
                                </td>
                            </tr>
                        </tbody>
